...
public class RowFilter implements CWritable {
  ...
  public static void main(String[] args) {
    RowFilter rowFilter = new RowFilter(new Row.Key("하여"), OP_LIKE);
    
    System.out.println("[" + rowFilter.getStartRowKey() + "][" + rowFilter.getEndRowKey() + "]");
    
    System.out.println(rowFilter.getStartRowKey().getLength() + "," + rowFilter.getEndRowKey().getLength());
    
    System.out.println((new Row.Key("하여")).compareTo(rowFilter.getEndRowKey()));
    System.out.println((new Row.Key("하여가")).compareTo(rowFilter.getEndRowKey()));
    System.out.println((new Row.Key("하오")).compareTo(rowFilter.getEndRowKey()));
  }
